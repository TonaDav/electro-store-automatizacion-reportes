...
from generador_datos import inventario
...
for venta in inventario.get_ventas():
    hoja_detalle_ventas.append([venta.id_venta, venta.producto.id_producto, venta.cliente.id_cliente, venta.vendedor.id_vendedor, venta.cantidad, venta.fecha,venta.calcular_total()])
